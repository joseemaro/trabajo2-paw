        ...
        class  validar{
            ...
            public function validarr(){
                ...
                if ($booleano) {
                    ...
                    //cargar vector para guardarlo en el archivo
                    $turno = new turno($_POST["nombre"],$_POST["email"],$_POST["telefono"] ,$_POST["edad"],
                    $_POST["talla"], $_POST["altura"], $_POST["fecha_nacimiento"] ,  $_POST["color"],
                    $_POST["fecha_turno"],$_POST["horario_turno"]);
